...
public class TextMessage implements Serializable {
     ...
     * forms the message.
     * 
     * @param bytes the bytes that form the message in UTF-8 coding.
     */
	public TextMessage(byte[] bytes) {
		this.msgBytes = addCtrChars(bytes);
		this.msg = new String(msgBytes, StandardCharsets.UTF_8);
	}
	...
	/**
	 * Returns an array of bytes that represent the UTF-8 coded message content.
	 * 
